...
class xoshiro512 {
	...
	::std::uint64_t s[8] = {0x243F6A8885A308D3u, 0x13198A2E03707344u, 0xA4093822299F31D0u, 0x082EFA98EC4E6C89u,
	                        0x452821E638D01377u, 0xBE5466CF34E90C6Cu, 0xC0AC29B7C97C50DDu, 0x3F84D5B5B5470917u};

public:
	xoshiro512(std::uint64_t const seed) {
		for(auto& x : s) {
			x ^= seed;
		}
	}
