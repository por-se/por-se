...
static void thread(void* arg) {
  ...
  // CHECK-CHILD-DAG: [state id: 0] registering broadcast with current thread [[SEC_TID]] on cond. var [[COND:[0-9]+]] and broadcasted threads: [[M_TID]]
...
int main(void) {
  ...
  // CHECK-MAIN-DAG: [state id: 0] registering broadcast with current thread [[SEC_TID]] on cond. var [[COND]] and broadcasted threads: [[M_TID]]
