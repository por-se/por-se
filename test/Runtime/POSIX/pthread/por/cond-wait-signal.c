...
static void thread(void* arg) {
  ...
  // CHECK-CHILD-DAG: POR event: signal with current thread [[SEC_TID]] on cond. var [[COND:[0-9]+]] and signalled thread [[M_TID]]
...
int main(void) {
  ...
  // CHECK-MAIN-DAG: POR event: signal with current thread [[SEC_TID]] on cond. var [[COND]] and signalled thread [[M_TID]]
